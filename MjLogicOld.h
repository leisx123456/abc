#ifndef MJ_LOGIC_HEAD_FILE
#define MJ_LOGIC_HEAD_FILE
...
class MjLogic
	:public CSingleton<MjLogic>
{

	//变量定义
protected:
	static const byte				m_cbCardDataArray_HZ[CARD_TOTAL_NUM];	//扑克数据
